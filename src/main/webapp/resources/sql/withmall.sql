...
-- 카테고리별 제품 리스트
SELECT ROW_NUMBER() OVER(ORDER BY P.PRDT_REAL_PRICE DESC) AS RN, IMAGE_PATH, FILESYSTEM_NAME, P.PRDT_NUM, PRDT_NAME, PRDT_TITLE, PRDT_INFO, PRDT_REAL_PRICE, PRDT_STOCK, PRDT_HIT, C.CATEGORY_NUM, CATEGORY_NAME
  FROM PRODUCT_IMAGE I, PRODUCT P, PRODUCT_CATEGORY C
 WHERE I.PRDT_NUM = P.PRDT_NUM
   AND P.CATEGORY_NUM = C.CATEGORY_NUM;
 
-- 제품 조회수 TOP 10  
SELECT RN, IMAGE_PATH, FILESYSTEM_NAME, PRDT_NUM, PRDT_NAME, PRDT_TITLE, PRDT_INFO, PRDT_REAL_PRICE, PRDT_STOCK, PRDT_HIT, CATEGORY_NUM, CATEGORY_NAME
