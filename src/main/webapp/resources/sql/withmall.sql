...
CREATE TABLE PRODUCT(
    ...
    CATEGORY_NUM    NUMBER(5)        NOT NULL UNIQUE,
    PRDT_HIT        NUMBER(8)        NOT NULL,
 CONSTRAINT PK_PRODUCT PRIMARY KEY (PRDT_NUM),
 CONSTRAINT FK_PRODUCT_CATEGORY FOREIGN KEY (CATEGORY_NUM) REFERENCES PRODUCT(CATEGORY_NUM)
);
...
-- 제품 카테고리 삽입 쿼리
INSERT INTO PRODUCT_CATEGORY(CATEGORY_NUM, CATEGORY_NAME) VALUES (PRODUCT_CATEGORY_SEQ.NEXTVAL, '카테고리1');
INSERT INTO PRODUCT_CATEGORY (CATEGORY_NUM, CATEGORY_NAME) VALUES (PRODUCT_CATEGORY_SEQ.NEXTVAL, '카테고리2');
INSERT INTO PRODUCT_CATEGORY (CATEGORY_NUM, CATEGORY_NAME) VALUES (PRODUCT_CATEGORY_SEQ.NEXTVAL, '카테고리3');
INSERT INTO PRODUCT_CATEGORY (CATEGORY_NUM, CATEGORY_NAME) VALUES (PRODUCT_CATEGORY_SEQ.NEXTVAL, '카테고리4');
-- 제품 상세 삽입 쿼리
INSERT INTO PRODUCT (PRDT_NUM, PRDT_NAME, PRDT_TITLE, PRDT_INFO, PRDT_REAL_PRICE, PRDT_STOCK, CATEGORY_NUM, PRDT_HIT)
VALUES (1, '제품1', '제품1 타이틀', '제품1 정보', 1000, 50, 1, 0);
INSERT INTO PRODUCT (PRDT_NUM, PRDT_NAME, PRDT_TITLE, PRDT_INFO, PRDT_REAL_PRICE, PRDT_STOCK, CATEGORY_NUM, PRDT_HIT)
VALUES (2, '제품2', '제품2 타이틀2', '제품2 정보', 2000, 100, 2, 2);
-- PRODUCT_IMAGE 테이블에 데이터 삽입
INSERT INTO PRODUCT_IMAGE (PRDT_NUM, IMAGE_PATH, FILESYSTEM_NAME) VALUES (1, '/images/product1.jpg', 'product1.jpg');
INSERT INTO PRODUCT_IMAGE (PRDT_NUM, IMAGE_PATH, FILESYSTEM_NAME) VALUES (2, '/images/product2.jpg', 'product2.jpg');
COMMIT;
