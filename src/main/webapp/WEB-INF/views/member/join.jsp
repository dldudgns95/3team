...
<div class="wrap wrap_7">
  ...
  <form id="frm_join" method="post" action="${contextPath}/member/join.do">
    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-5"><input type="button" class="btn btn-dark" onclick="execDaumPostcode()" value="우편번호 찾기"></div>
    </div>
...
function execDaumPostcode() {
  new daum.Postcode({
    oncomplete: function(data) {
      ...
      var roadAddr = data.roadAddress; // 수정: roadaddress 대신 roadAddress 사용
      ...
      document.getElementById("jibunaddress").value = data.jibunAddress; // 수정: jibunaddress 대신 jibunAddress 사용
    ...
    <div class="mt-3 text-center">
      ...
      <button type="submit" class="btn btn-dark">회원가입하기</button>
    </div>
